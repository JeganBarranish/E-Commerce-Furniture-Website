...
const LoginFormComponent = ({ active = false, onClose, onSwitchToSignup }) => {
  const { login } = useAuth();
    ...
    <>
      ...
      >
        <LoginForm onSubmit={handleSubmit}>
          ...
          <FormText>
            don't have an account? <Link onClick={handleSwitchToSignup} sx={{ cursor: 'pointer' }}>create now</Link>
          </FormText>
        </LoginForm>
      </LoginDialog>
